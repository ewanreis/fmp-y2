   ...
   private void OnEnable()
    {
        ...
        leftPatrolPoint = UnityEngine.GameObject.Find("LeftCastlePointFar").transform;
        rightPatrolPoint = UnityEngine.GameObject.Find("RightCastlePointFar").transform;
    }
