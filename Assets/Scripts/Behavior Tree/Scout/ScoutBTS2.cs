...
public class ScoutBTS2 : Tree
{
    ...
    protected override Node SetupTree()
    {
        Node root = new Selector(new List<Node>
        {
            ...
            new TaskPatrol(this.transform, leftPatrolPoint, rightPatrolPoint, wanderSpeed, waitTime)
   ...
   private void OnEnable()
    {
        ...
        leftPatrolPoint = UnityEngine.GameObject.Find("LeftCastlePointMedium").transform;
        rightPatrolPoint = UnityEngine.GameObject.Find("RightCastlePointMedium").transform;
    }
