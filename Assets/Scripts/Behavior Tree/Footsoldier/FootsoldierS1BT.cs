...
public class FootsoldierS1BT : Tree
{
    ...
    [UnityEngine.SerializeField] private Health _enemyHealth;
    ...
    protected override Node SetupTree()
    {
        Node root = new Selector(new List<Node>
        {
            ...
            new TaskWanderEnemy(this.transform, groundLayer, wanderSpeed, targetTransform, EnemyTypes.Footsoldier)
